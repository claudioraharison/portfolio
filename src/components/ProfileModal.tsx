...
import { X, Mail, Phone, MapPin, Download, Briefcase, Award, GraduationCap, Calendar, Languages, Code, Database, Map } from 'lucide-react';
...
const ProfileModal: React.FC<ProfileModalProps> = ({ isOpen, onClose }) => {
  ...
  // Textes traduits
//   const title = useAutoTranslatedText('modal.title', 'Informations Professionnelles');
        ...
        <div className="bg-gradient-to-r from-blue-950 to-blue-800 text-white p-6">
          <div className="flex justify-between items-start">
            <div className="flex items-center space-x-4">
              <div className="w-20 h-20 rounded-full border-4 border-white/40 overflow-hidden shadow-xl">
                <img 
                  src={profileImage} 
